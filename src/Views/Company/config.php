      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-10 mb-3">
            <input type="text" id="disabledTextInput" class="form-control bg-dark text-white bg-dark text-white" value=<?= $this->data['fantasia'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">Razão:</label>
          <div class="col-sm-10 mb-3">
            <input type="text" id="reason" class="form-control bg-dark text-white bg-dark text-white" value=<?= $this->data['razao'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">CNPJ:</label>
          <div class="col-sm-10 mb-3">
            <input type="text" id="cnpj" class="form-control bg-dark text-white" value=<?= $this->data['cnpj'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">Email:</label>
          <div class="col-sm-10 mb-3">
            <input type="text" id="email" class="form-control bg-dark text-white" value=<?= $this->data['email'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">Telefone:</label>
          <div class="col-sm-10 mb-3">
            <input type="text" id="contact" class="form-control bg-dark text-white col-xl-8 col-lg-8 col-md-8 col-sm-12" value=<?= $this->data['contato'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">Cidade:</label>
          <div class="col-sm-10 mb-3">
            <input type="text" id="locality" class="form-control bg-dark text-white col-xl-8 col-lg-8 col-md-8 col-sm-12" value=<?= $this->data['cidade'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">Estado:</label>
          <div class="col-sm-10 mb-3">
            <input type="text" id="uf" class="form-control bg-dark text-white col-xl-2 col-lg-2 col-md-5 col-sm-12" value=<?= $this->data['uf'] ?? "''"; ?> disabled>
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-sm-2 col-form-label">Plano:</label>
          <div class="col-sm-10">
            <select id="typePackage" class="custom-select bg-dark text-white col-xl-5 col-lg-5 col-md-10 col-sm-12" disabled>
        ...
        <div class="form-group row">
          <div class="input-group mb-3">
            ...
            <input id="passwd" type="password" class="form-control bg-dark text-white ml-3 col-xl-8 col-lg-8 col-md-10 col-sm-12 rounded" autocomplete="current-password" maxlength="20" disabled/>
        ...
        <div class="form-group row confirmPasswd" style="display: none;">
          ...
          <div class="col-sm-10">
            <input id="confirmPasswd" type="password" class="form-control bg-dark text-white col-xl-10 col-lg-10 col-md-5 col-sm-12" disabled>
          </div>
        </div>
      </div>
    </div>
