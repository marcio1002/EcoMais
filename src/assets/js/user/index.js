        ...
        if (isMobile()) {
          ...
          let cardsCompany = res.data.map(val => {
            return `
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="card shadow bg-dark border-secondary text-light w-100">
                  <img class="card-img-top img-fluid" style="max-height: 100%; height: 20em" src="${val.imagem ? val.imagem : 'https://127.0.0.1/www/ecomais/src/assets/imgs/logo-atacado-default.jpg'}" alt="Imagem de capa do card">
                  <div class="card-body border-top">
                    <h5 class="card-title">${val.fantasia}</h5>
                    <a href="${BASE_URL}/usuario/listadeprodutos?id_company=${val.id_empresa}" class="btn btn-block font-weight-bold btn-primary">Visitar</a>
                  </div>
